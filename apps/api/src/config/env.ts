...
const schema = z.object({
  ...
  IPFS_PROVIDER: z.enum(["auto", "filebase", "pinata", "nft_storage"]).default("filebase"),
  FILEBASE_ACCESS_KEY: z.string().optional(),
  FILEBASE_SECRET_KEY: z.string().optional(),
  FILEBASE_BUCKET: z.string().optional(),
  FILEBASE_S3_ENDPOINT: z.string().url().default("https://s3.filebase.com"),
  FILEBASE_GATEWAY: optionalUrlWithDefault("https://ipfs.filebase.io/ipfs"),
  ...
  SINGLE_NFT_MINTER_BASE_SEPOLIA: z.string().optional(),
  SINGLE_NFT_MINTER_BASE_MAINNET: z.string().optional(),
  SINGLE_NFT_MINTER_SEPOLIA: z.string().optional(),
  SINGLE_NFT_MINTER_POLYGON_AMOY: z.string().optional(),
  NEXMINT_MARKETPLACE_BASE_SEPOLIA: z.string().optional(),
  NEXMINT_MARKETPLACE_BASE_MAINNET: z.string().optional(),
  NEXMINT_MARKETPLACE_SEPOLIA: z.string().optional(),
  NEXMINT_MARKETPLACE_POLYGON_AMOY: z.string().optional(),
  MARKETPLACE_PLATFORM_FEE_BPS: z.coerce.number().int().min(0).max(1000).default(250),
  BASE_SEPOLIA_SINGLE_NFT_CONTRACT: z.string().optional(),
